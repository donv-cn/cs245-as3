...
//		System.out.println("max < 1000  iopCount_delta: " + iopCount_delta);
		//... or if the log ever became too long:
		assert(maxLogSizeUntruncated < 50000);
//		System.out.println("max < 50000  maxLogSizeUntruncated: " + maxLogSizeUntruncated);
	}
